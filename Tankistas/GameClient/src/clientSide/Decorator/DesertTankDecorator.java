// src/clientSide/DesertTankDecorator.java
...
public class DesertTankDecorator extends TankDecorator {

    public DesertTankDecorator(Tank decoratedTank) {
        super(decoratedTank);
    }
    ...
    public void loadImage(int a) {
        ...
        for (int i = a; i < tankImg.length + a; i++) {
            String imagePath = System.getProperty("user.dir") + "/Images/D" + (i - a + 1) + ".PNG";
