// src/clientSide/ForestTankDecorator.java
...
public class ForestTankDecorator extends TankDecorator {

    public ForestTankDecorator(Tank decoratedTank) {
        super(decoratedTank);
    }
    ...
    public void loadImage(int a) {
        ...
        for (int i = a; i < tankImg.length + a; i++) {
            String imagePath = System.getProperty("user.dir") + "/Images/F" + (i - a + 1) + ".PNG";
